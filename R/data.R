#' Datos primarios del inventario de recursos naturales de La Pampa.
#'
#' Los datos corresponden a más de 300 censos de vegetación
#' y 150 calicatas de suelos realizados durante 1975 a 1979,
#' utilizados para la caracterización de los recursos naturales
#'  de la Provincia de La Pampa.
#'
#' @format ## `inventario`
#' A data frame with 29,386 rows and 26 columns:
#' \describe{
...
#'   \item{geometry}{lacalizacion donde se realizo el censo}
#' }
