...
# Generar reporte para el censo número 503
reporte <- reporte_especie(503)
head(reporte)
```
...
reporte_varios <- reporte_especie(c(75, 76, 77))
...
```{r ejemplo-integrado}
# 1. Obtener especies del censo 503
especies_censo_503 <- reporte_especie(503)

# Ver las primeras especies encontradas
head(especies_censo_503, 3)

# 2. Tomar la primera especie y ver su distribución
primera_especie <- especies_censo_503$nombreCientificoEspecie[1]
